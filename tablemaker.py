...
def main():
    ...
    while not stopper:
        for rounds in partitions(31, 7): #Verteilt 30€ Einsatz auf 7 Runden
            ...
            a, b, c, d, e, f, g = calculate_bets(rx)

            possible_win = win_math(a, b, c, d, e, f, g)
            possible_risk = risk_math(a, b, c, d, e, f, g)
            risk_ratio = combined_math(a, b, c, d, e, f, g)
...
def combined_math(a, b, c, d, e, f, g):
    rr1 = win_math(a, b, c, d, e, f, g)
    rr2 = risk_math(a, b, c, d, e, f, g)
    risk_ratio = rr1 / rr2
    return risk_ratio
